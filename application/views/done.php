...
.row{padding:0;}*/
/*#cstart{background:url(/images/<?php echo $hehe; ?>.jpg);background-size:100% 90%;}*/
/*#again, #share{border:1px solid #000;}*/
body{width: 100%;
    height: 100%;
...
$(function() {
    ...
    $('#cstart').css('background', 'url(/images/<?php echo $hehe; ?>.png) no-repeat');
    $('#cstart').css('background-position', '50% 50%');
    $('#cstart').css('background-size', 'auto 100%');
